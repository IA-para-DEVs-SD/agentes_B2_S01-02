...
Versão 1 — Workflow com OpenAI

Nesta versão, o código controla o passo a passo:

1. Lê feedbacks do banco
2. Chama OpenAI para analisar cada feedback
...
7. Gera texto executivo com OpenAI
...
# ---------------------------------------------------------
# 2. Criar cliente OpenAI e conexão com banco
# ---------------------------------------------------------
...
def analyze_feedback(feedback_id: int, feedback_text: str) -> Dict[str, Any]:
    """
    Usa OpenAI para classificar um feedback.
...
def generate_executive_text(report: Dict[str, Any]) -> str:
    """
    Usa OpenAI para transformar o relatório em texto executivo.
    """
